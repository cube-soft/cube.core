...
namespace Cube.Forms.Behaviors
{
    ...
    ///
    /* --------------------------------------------------------------------- */
    public class ClosingBehavior : DisposableBase
    {
        #region Constructors
        ...
        ///
        /* ----------------------------------------------------------------- */
        public ClosingBehavior(Form src, Action<FormClosingEventArgs> action)
        {
            void invoke(object s, FormClosingEventArgs e) => action(e);
            src.FormClosing += invoke;
            _subscriber = Disposable.Create(() => src.FormClosing -= invoke);
        }
