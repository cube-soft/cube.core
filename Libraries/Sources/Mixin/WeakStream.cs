...
namespace Cube.Mixin.Drawing
{
    ...
    ///
    /* --------------------------------------------------------------------- */
    internal sealed class WeakStream : Stream
    {
        /* ----------------------------------------------------------------- */
        ///
        /// WeakStream
        ///
        /// <summary>
        /// Initializes a new instance of the WeakStream class with the
        /// specified stream.
        /// </summary>
        ///
        ...
        ///
        /* ----------------------------------------------------------------- */
        public WeakStream(Stream stream) : this(stream, false) { }
        ...
        ///
        /* ----------------------------------------------------------------- */
        public WeakStream(Stream stream, bool leaveOpen)
        {
            _source = stream;
            _leave  = leaveOpen;
        }
