...
internal class ButtonPainter
{
    ...
    protected virtual void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        var bounds = GetDrawBounds(client, Source.Padding);
        gs.FillBackground(GetBackColor());
        gs.DrawImage(client, GetBackgroundImage(), Source.BackgroundImageLayout);
        gs.DrawImage(bounds, GetImage(), Source.ImageAlign);
        gs.DrawText(bounds, Content, Source.Font, GetContentColor(), Source.TextAlign);
    ...
    private void DisableSystemStyle()
    {
        ...
        Source.FlatAppearance.MouseDownBackColor = color;
        Source.FlatAppearance.MouseOverBackColor = color;
...
///
/* ------------------------------------------------------------------------- */
internal sealed class RadioButtonPainter : ButtonPainter
{
    #region Constructors
...
///
/* ------------------------------------------------------------------------- */
internal sealed class ToggleButtonPainter : ButtonPainter
{
    #region Constructors
