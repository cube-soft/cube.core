...
[![Azure Pipelines](https://dev.azure.com/cube-soft-jp/Cube.Core/_apis/build/status/cube-soft.Cube.Core?branchName=master)](https://dev.azure.com/cube-soft-jp/Cube.Core/_build/latest?definitionId=1&branchName=master)
