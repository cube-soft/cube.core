...
namespace Cube.FileSystem
{
    /* --------------------------------------------------------------------- */
    ///
    /// Cube.FileSystem.DriveDetacher
    /// 
    /// <summary>
    /// ドライブを取り外すためのクラスです。
    /// </summary>
    /// 
    /// <see cref="http://www.codeproject.com/Articles/13839/How-to-Prepare-a-USB-Drive-for-Safe-Removal"/>
    ///
    /* --------------------------------------------------------------------- */
    internal class DriveDetacher
    {
        #region Methods
        ...
        /// 
        /* ----------------------------------------------------------------- */
        public static bool Run(string driveCharWithColon)
        {
        ...
        /// 
        /// <summary>
        /// returns the device instance handle of a storage volume or 0
        /// on error
        /// </summary>
        /// 
        /* ----------------------------------------------------------------- */
        static long GetDrivesDevInstByDeviceNumber(long DeviceNumber, DriveType DriveType, string dosDeviceName)
        {
            ...
            while (true)
            {
                ...
                if (IntPtr.Size == 8)
                    detailData.cbSize = 8;                                                                          // for 64bit operating systems
                else
                    detailData.cbSize = Marshal.SizeOf(typeof(SP_DEVICE_INTERFACE_DETAIL_DATA));                    // for 32bit operating systems
